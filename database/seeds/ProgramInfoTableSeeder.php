    ...
    public function run()
    {
        ...
        [
            [
                ...
                'privilege_1_url' => 'img/sui1.jpg',
                'privilege_2_url' => 'img/sui2.jpg'
            ],
            [
                'program_id' => '2',
                ...
                'privilege_1_url' => 'img/Hatsumimi_img1.jpg',
                'privilege_2_url' => 'img/Hatsumimi_img2.jpg'
            ],
            [
                'program_id' => '3',
                ...
                'privilege_1_url' => 'img/hkt48_img1.jpg',
                'privilege_2_url' => 'img/hkt48_img2.jpg'
            ],
            [
                'program_id' => '4',
                ...
                'privilege_2' => '2016年10月29日放映分の特別招待券を応援ランキング上位20名様にプレゼント！さらに、上位5名様には出演者との記念撮影も！',
                'privilege_1_url' => 'img/gorou_img1.jpg',
                'privilege_2_url' => 'img/gorou_img2.jpg'
            ]
        ];

        foreach ($program_infos as $index => $program_info) {
            $programInfoData = $this->program_info->create(
                intval($program_info['program_id']),
                $program_info['description'],
                $program_info['next_broadcast_time'],
                $program_info['next_description'],
                $program_info['privilege_1'],
                $program_info['privilege_2'],
                $program_info['privilege_1_url'],
                $program_info['privilege_2_url']
            );
